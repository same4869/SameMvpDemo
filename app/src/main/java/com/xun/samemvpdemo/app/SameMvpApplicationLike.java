...
public class SameMvpApplicationLike extends DefaultApplicationLike {
    ...
    public void onBaseContextAttached(Context base) {
        ...
        SameMvpApplicationContext.application = getApplication();
    ...
    protected void installLeakCanary() {
        this.mRefWatcher = Constants.USE_CANARY ? LeakCanary.install(SameMvpApplicationContext.application) : RefWatcher.DISABLED;
    }
